...
public class IndexController {
	...
	public List<Product> search(Model model, @RequestParam("keywords") Optional<String> kw) {
		String kwords = kw.orElse(sessionService.get("keywords"));
		sessionService.set("keywords", kwords);
		System.out.print(kwords);
		List<Product> list = productDao.fillByKeywords("%" + kwords + "%");
		return list;
	}
