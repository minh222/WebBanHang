...
public class AddressController {
	...
	// get thông tin cá nhân của address set vào entity -> addAttribute entity vào addressForm
	...
	// checkout
	// get thông tin cá nhân của entity set vào address -> dùng hàm save() của dao save address
	...
	public String save(Model model, @ModelAttribute("addressForm") @Validated AddressModel entity,
		...
		if (result.hasErrors()) {
			...
			for (Item i : listItem) {			
				...
				Order order = new Order(String.valueOf(code), false, entity.isPayment(), i.getQuality(), strDate,  address, product);
