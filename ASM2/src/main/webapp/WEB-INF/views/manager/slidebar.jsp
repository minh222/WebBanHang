...
<body>
	...
	<ul
		...
		<a
			...
			<div class="sidebar-brand-text mx-3">Quản lí MGear</div>
		</a>
		...
		<li class="nav-item"><a class="nav-link collapsed" href="#"
			...
			<div id="collapseProduct" class="collapse"
				...
				<div class="bg-white py-2 collapse-inner rounded">
					...
					<a class="collapse-item" href="/admin/productForm/form">Edit
		...
		<li class="nav-item"><a class="nav-link collapsed" href="#"
			...
			<div id="collapseManu" class="collapse"
				...
				<div class="bg-white py-2 collapse-inner rounded">
					...
					<a class="collapse-item" href="/admin/manuForm/form">Edit
		...
		<li class="nav-item"><a class="nav-link collapsed" href="#"
			...
			<div id="collapseCate" class="collapse"
				...
				<div class="bg-white py-2 collapse-inner rounded">
					...
					<a class="collapse-item" href="/admin/categoryForm/form">Edit
		...
		<li class="nav-item"><a class="nav-link collapsed" href="#"
			...
			<div id="collapseUser" class="collapse"
				...
				<div class="bg-white py-2 collapse-inner rounded">
					...
					<a class="collapse-item" href="/admin/userForm/form">Edit Người
