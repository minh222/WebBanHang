		...
		<div class="container-fluid">
			<div class="row px-xl-5">
				<div class="col-lg-4">
					...
					<div class="mb-4">
						<h5 class="section-title position-relative text-uppercase mb-3">
							<span class="bg-secondary pr-2">Thanh toán</span>
						</h5>
						<div class="bg-light p-30">
							...
							<button type="submit"
								class="btn btn-block btn-primary font-weight-bold py-3">Check Out</button>
						</div>
					</div>
				</div>
				<div class="col-lg-8">
						...
						<div class="row">
							<div class="col-md-6 form-group">
								...
								<form:input path="firstname" cssClass="form-control"
									cssErrorClass="form-control is-invalid" placeholder="" />
