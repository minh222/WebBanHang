							...
							<div class="ml-2">
								<div class="btn-group">
									...
									<div class="dropdown-menu dropdown-menu-right">
										<a class="dropdown-item" href="#">A to Z</a> <a
											class="dropdown-item" href="#">Z to A</a> 
									</div>
								</div>
...
<!-- 								</div> -->
					...
					<c:forEach var="item" items="${shop.content}">
						<div class="col-lg-2 col-md-6 col-sm-6 pb-1 mx-auto">
							<div class="product-item bg-light mb-4">
								<div class="product-img position-relative overflow-hidden">
									<img class="img-fluid1 w-100 h-25" src="/upload/${item.image}"
										alt="">
								...
								<div class="text-center py-4">
									...
									<div
										...
										<small class="fa fa-star text-primary mr-1"></small> <small
											...
											class="fa fa-star text-primary mr-1"></small> <small
											class="fa fa-star text-primary mr-1"></small> <small
											class="fa fa-star text-primary mr-1"></small> <small>(69	)</small>
									</div>
								</div>
							</div>
						</div>
